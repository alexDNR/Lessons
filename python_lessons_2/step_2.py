...
"Недостаточная масса", если ИМТ меньше 18.5 и "Избыточная масса", 
если значение ИМТ больше 25.
    Формат входных данных
...
с ним животного. Ваша программа должна корректно работать 
...
'''
# zodiak = ["Дракон", "Змея", "Лошадь", "Овца", "Обезьяна", 
# "Петух", "Собака", "Свинья", "Крыса", "Бык", "Тигр", "Заяц"]
# year = int(input())
# print(zodiak[year % 12-8])
# -8 в индексе потому что список смещен на 8 вправо.Вообще 0 год - это год Обезьяны
