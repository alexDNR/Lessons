...
'''
Используя генератор множеств, дополните приведенный код так, чтобы получить множество, 
содержащее уникальные слова  строки sentence длиною меньше  4 символов. Результат вывести на одной строке (в нижнем регистре) 
...
'''
Используя генератор множеств, дополните приведенный код так, чтобы он выбрал из списка files уникальные имена файлов c расширением 
.png, независимо от регистра имен и расширений. Имена файлов вывести вместе с расширением, 
...
'''
Домашнее задание
Учитель проверяет домашнее задание в классе и получил следующие ответы: из n школьников у m домашнее задание съела собака, у 
k отключили свет, а у p учеников постигли оба несчастья. Напишите программу, которая определяет сколько человек выполнило домашнее задание.
...
n – количество названных городов, в последующих n строках вводятся названные города и ещё одна строка с новым, только что названым городом.
    Формат выходных данных
Программа должна вывести OK, если этот город ещё не вспоминали, и REPEAT, если город уже был назван.
'''
# n = int(input())
# mylist = [input() for _ in range(0,n)]
# mylist.append(input())
# myset = set(mylist)
# print('REPEAT' if len(myset ) < len(mylist) else 'OK')

# n = int(input())
# mylist = [input() for _ in range(0,n+1)]
# myset = set(mylist)
# print('REPEAT' if len(myset) < len(mylist) else 'OK')
...
Напишите программу, определяющую для каждой книги из списка на прочтение, есть она у Руслана или нет.
    Формат входных данных
На вход программе в первой строке подается натуральное число m — количество книг в домашней библиотеке Руслана. Во второй строке записано натуральное число 
n —  количество книг в списке на лето. Далее идут m строк с названиями книг из домашней библиотеки и n строк названий из списка на лето.
    Формат выходных данных
...
# n = int(input())
# answer = []
# myset = {input() for _ in range(0,m)}
# for i in range(0,n):
#     if input() in myset:
#         answer.append('YES')
#     else:
...
# m = int(input())
# n = int(input())
# set_m = {input() for _ in range(0,m)}
# set_n = {input() for _ in range(0,n)}
...
# set_m = {input() for _ in range(0,m)}
# set_n = {input() for _ in range(0,n)}
# if set_m.symmetric_difference(set_n) == set():
#     print("NO")
# else:
#     print(len(set_m.symmetric_difference(set_n)))
...
#     else:
#         s1.add(s)
# print("NO" if len(s1)==0 else len(s1))            
...
На первой строке каждого блока указано количество фамилий n-i
...
2 - количество уроков
4 - количество учеников на уроке
Черкасов
Фокин
Самойлов
Устинов
...
# n = int(input())
# empty_set = set()
# first_set = set([input() for _ in range(n)]) # записываем учеников первого урока
# if m == 1:   # если урок один, то просто сразу выводим список учеников
#     print(*sorted(first_set), sep='\n')
# else: # иначе, если уроков больше одного, то
#     for i in range(m-1): # запускаем цикл по количеству уроков минус 1-ый урок
#         for j in range(int(input())): # запускаем цикл по количеству учеников
#             empty_set.add(input()) # в пустое множество добавляем учеников
#         first_set.intersection_update(empty_set) # ищем пересечение двух множеств и меняем значение списка учеников первого урока
#         empty_set.clear() 
#     print(*sorted(first_set), sep='\n')  # в конце у нас останется список тех учеников, которые были все уроки            

# это решение препода курса
# n = int(input())
